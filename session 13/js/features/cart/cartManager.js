import { cartBtn, cartCloseBtn, cartElement, cartList, descriptionElement, itemsCount, itemsElement, similarProductsElement } from "../../shares/ui/dom-element.js";
...
export default class cartManager{
    ...
    #addProductToCart = function(){
        ...
        similarProductsElement.on("click", (e) =>{
            console.log("clicked on items from new.html");
            
            if ($(e.target).attr("data-item-test2")){
                console.log("inside the if");
                
                const clickedItem = JSON.parse($(e.target).attr("data-item-test2"));
                clickedItem_ID = clickedItem.id;
                clickedItem_Category = clickedItem.category;
                localStorage.setItem("clickedItem_ID", clickedItem_ID);
                localStorage.setItem("clickedItem_Category", clickedItem_Category);
